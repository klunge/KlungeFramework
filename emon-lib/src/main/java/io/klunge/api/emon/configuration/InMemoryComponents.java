...
import io.klunge.api.emon.configuration.hazelcast.MulticastConfig;
import io.klunge.api.emon.configuration.hazelcast.UserCodeDeploymentConfig;
...
public class InMemoryComponents {
    ...
    @Value("${klunge.eventBus.consumer.groupId}")
